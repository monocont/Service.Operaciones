            ...
            foreach (var r in resultados)
            {
                ...
                else
                {
                    var entidad = VentaEmpresaEntity.Crear(
                        ...
                        serie: r.Serie ?? "",
                        numero: r.Numero ?? "",
                        codigoTipoDocIdentidad: r.CodigoTipoDocIdentidad ?? "0",
                        ...
                        valorFacturadoExportacion: r.ValorFacturadoExportacion ?? 0,
                        biGravada: r.BiGravada ?? 0,
                        descuentoBi: r.DescuentoBi ?? 0,
                        igvIpm: r.IgvIpm ?? 0,
                        descuentoIgv: r.DescuentoIgv ?? 0,
                        montoExonerado: r.MontoExonerado ?? 0,
                        montoInafecto: r.MontoInafecto ?? 0,
                        montoIsc: r.MontoIsc ?? 0,
                        biGravadaIvap: r.BiGravadaIvap ?? 0,
                        montoIvap: r.MontoIvap ?? 0,
