namespace Service.Operaciones.Application.DTOs.CompraMatch;

public class CompraMatchDTO
{
    ...
    public bool EsCoincidenciaExacta { get; set; }
    public bool EsDiferencia { get; set; }
    public bool EsSoloUnOrigen { get; set; }
