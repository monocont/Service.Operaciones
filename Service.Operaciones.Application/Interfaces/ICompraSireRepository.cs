...
public interface ICompraSireRepository
{
    Task<List<CompraSire>> ListarPorCargaAsync(Guid idCarga, CancellationToken cancellationToken);
    ...
    Task AgregarRangoAsync(List<CompraSire> compras, CancellationToken cancellationToken);
    Task<List<CompraSire>> ObtenerPorIdsAsync(List<Guid> idsCompra, CancellationToken cancellationToken);
    ...
    Task<List<string>> ObtenerNumerosPorSerieYPeriodoAsync(string empresaRuc, string periodo, string tipoCp, string serie, CancellationToken cancellationToken);
}
