...
public class OperacionesDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Venta>(entity =>
        {
            ...
            entity.Property(e => e.NroDocIdentidad).HasColumnName("nro_doc_identidad").HasMaxLength(15).IsRequired();
            entity.Property(e => e.RazonSocial).HasColumnName("razon_social").HasMaxLength(200).IsRequired();
            entity.Property(e => e.ValorFactExp).HasColumnName("valor_fact_exp").HasColumnType("numeric(14,2)");
            entity.Property(e => e.BiGravada).HasColumnName("bi_gravada").HasColumnType("numeric(14,2)");
            entity.Property(e => e.DsctoBi).HasColumnName("dscto_bi").HasColumnType("numeric(14,2)");
            entity.Property(e => e.IgvIpm).HasColumnName("igv_ipm").HasColumnType("numeric(14,2)");
            entity.Property(e => e.DsctoIgvIpm).HasColumnName("dscto_igv_ipm").HasColumnType("numeric(14,2)");
            ...
            entity.Property(e => e.Isc).HasColumnName("isc").HasColumnType("numeric(14,2)");
            entity.Property(e => e.BiGravIvap).HasColumnName("bi_grav_ivap").HasColumnType("numeric(14,2)");
            ...
            entity.Property(e => e.SerieCpModificado).HasColumnName("serie_cp_modificado").HasMaxLength(10);
            entity.Property(e => e.NroCpModificado).HasColumnName("nro_cp_modificado").HasMaxLength(20);
            entity.Property(e => e.IdProyectoOpAttr).HasColumnName("id_proyecto_op_attr").HasMaxLength(50);
            entity.Property(e => e.ValorFobEmbar).HasColumnName("valor_fob_embar").HasColumnType("numeric(14,2)");
            entity.Property(e => e.ValorOpGratuitas).HasColumnName("valor_op_gratuitas").HasColumnType("numeric(14,2)");
