...
/// <summary>
/// Parser de archivo de Ventas en formato TXT (delimitador pipe |).
/// Layout oficial SUNAT LE: 41 columnas.
/// Encabezado: Ruc|Razon Social|Periodo|CAR SUNAT|Fecha de emisión|...
/// </summary>
public class VentaTxtParser : ArchivoSunatParserBase, IArchivoSunatParser
{
    ...
    public async Task<List<ResultadoParseoLinea>> ParsearAsync(Stream stream, CancellationToken cancellationToken)
    {
        ...
        while ((linea = await reader.ReadLineAsync(cancellationToken)) is not null)
        {
            ...
            // Mapear campos obligatorios que pueden faltar con defaults
    ...
    private static bool EsEncabezado(string linea)
    {
        ...
        // El encabezado en Ventas suele ser "Ruc" (mixto mayuscula/minuscula)
